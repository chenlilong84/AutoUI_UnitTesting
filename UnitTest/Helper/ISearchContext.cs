...
namespace PP5AutoUITests
{
    ...
    public interface ISearchContext
    {
        ...
        /// <returns>The first matching <see cref="IElement"/> on the current context.</returns>
        /// <exception cref="NoSuchElementException">If no element matches the criteria.</exception>
        IElement FindElement(By by);

        /// <summary>
        /// Finds all <see cref="IElement">IWebElements</see> within the current context
        /// using the given mechanism.
        /// </summary>
        /// <param name="by">The locating mechanism to use.</param>
        /// <returns>A <see cref="ReadOnlyCollection{T}"/> of all <see cref="IElement">WebElements</see>
